...
class RFDevice:
    def __init__(self, gpio = None,
                 glitch=150, rx_min_bits=24, rx_max_bits=24, rx_callback=None,
        ...
        self._rx_timer=Timer()
        self._rx_single_timer=Timer()
        self._rx_last_edge=None
        self._rx_cb = rx_callback
        self._rx_min_bits = rx_min_bits
        self._rx_max_bits = rx_max_bits
        self._rx_glitch=glitch
        self._rx_single_press=False
    ...
    def disable_tx(self):
        ...
        if self.tx_enabled:
            ...
            self.gpio = Pin(TX_PIN, Pin.IN, Pin.PULL_DOWN)
            self.tx_enabled = False
            print("TX disabled")
        return True
    ...
    def enable_rx(self):
        ...
        if not self.rx_enabled:
            ...
            print("RX enabled, pin: " + str(RX_PIN))
        return True
    ...
    def details(self):
        ...
        """
        self._ready = False
        return self.rx_code, self._lbits, self._lgap, self._lt0, self._lt1
    
    # pylint: disable=unused-argument
    def rx_callback(self, gpio=None):
    ...
    def _rx_waveform(self, pnum, change_count, timestamp):
        ...
        if self._rx_change_count > 6 and code != 0:            
            ...
            if self._rx_cb is not None:
                self._rx_cb(code,timestamp,self.rx_bitlength,self.rx_pulselength,self.rx_proto)
